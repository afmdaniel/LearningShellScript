...
# Retorna 3 para formato inválido
	...
	then
		return 0
	elif [ $VAL1 -gt 12 -a $VAL2 -le 12 ]; then   # Formato BR
		return 0
	elif [ $VAL1 -le 12 -a $VAL2 -gt 12 ]; then   # Formato US
		return 1
	elif [ $VAL1 -le 12 -a $VAL2 -le 12 ]; then  	# Formato Indefinido, mas válido
		return 2
	else
		return 3
	fi
